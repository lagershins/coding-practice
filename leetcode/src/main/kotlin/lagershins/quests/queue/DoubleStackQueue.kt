...
class DoubleStackQueue {
	// Runtime: 10ms (100%) Memory: 42.88MB (66.14%)
	private val back = LinkedList<Int>()
	private val front = LinkedList<Int>()

	private fun moveTo(a: LinkedList<Int>, b: LinkedList<Int>) {
		for (i in 0..<a.size) {
			b.push(a.pop())
		}
	}
